        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatestWeight = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    StartingWeight = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    GoalWeight = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkoutName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
